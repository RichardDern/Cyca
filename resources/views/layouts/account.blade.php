...
<a href="{{ route('account.groups') }}" class="{{ url()->current() === route('account.groups') ? 'selected' : '' }}">{{ __('Groups') }}</a>
...
<a href="{{ route('account.history') }}" class="{{ url()->current() === route('account.history') ? 'selected' : '' }}">{{ __('History') }}</a>
