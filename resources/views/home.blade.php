...
<div class="sm:w-5/12 xl:w-7/12 h-screen flex flex-col bg-gray-50 dark:bg-gray-800">
    <feed-items-list class="h-2/6 overflow-auto" v-on:selected-feeditems-changed="onSelectedFeedItemsChanged" v-if="showFeedItemsList">
    </feed-items-list>
    <div v-bind:class="{'h-full': !showFeedItemsList, 'h-4/6': showFeedItemsList }">
